...
# Hyper-parameters
class Args:
    version = "0.3_only_hitwall_minbuffer"  # model version
    ...
    gamma = 0.99  # the discount factor gamma 这个要再高一些 0.999左右，也可以是1
    ...
    max_grad_norm = 1.0  # the maximum norm for the gradient clipping
